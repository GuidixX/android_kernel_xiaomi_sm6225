...
static int wl2866d_match_id(struct device *dev)
{
	...
	ret = wl2866d_read_reg(wl2866d_data.id_reg,
 ...
 * @return  read count
 */
static ssize_t wl2866d_read(struct file *file, char __user *buf, size_t count, loff_t *offset)
{
	char *buffer = NULL;
	int ret = 0, num = 0, i = 0;
 ...
 * @return  write count
 */
static ssize_t wl2866d_write(struct file *file, const char __user *buf, size_t count, loff_t *offset)
{
	int ret = 0, i = 0;
	char *buffer = NULL;
